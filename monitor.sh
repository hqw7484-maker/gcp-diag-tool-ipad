...
echo -e "\033[0m"
echo -e "    ─────────────────────────────────────────────────────────────"
echo -e "    \033[1mGuard:\033[0m Active  |  \033[1mMode:\033[0m Xray-Fallback | \033[1mEngine:\033[0m iPadOS"
echo -e "    ─────────────────────────────────────────────────────────────"
...
do
    ...
    # 状态检测
    if pgrep -x "xray" > /dev/null && pgrep -x "cf" > /dev/null; then STATUS="\033[32mON\033[0m"; else STATUS="\033[31mOFF\033[0m"; fi
